    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="text-center mb-4">
          <div className="inline-flex items-center justify-center w-11 h-11 rounded-full bg-blue-100 text-blue-700 mb-2">
        ...
        <div className="mb-4 bg-blue-50/70 border border-blue-200 rounded-xl p-3">
          ...
          <div className="space-y-1.5">
            {sampleTokens.map((item, idx) => (
              <button
                ...
                className="w-full text-right bg-white hover:bg-blue-600 hover:text-white text-slate-700 text-xs px-3 py-2 rounded-lg border border-blue-100 font-medium transition-colors flex items-center justify-between"
              >
                <span>{item.name}</span>
        ...
        <form onSubmit={handleManualSubmit} className="space-y-2">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="w-full text-xs px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 focus:outline-hidden focus:ring-2 focus:ring-blue-500"
            />
            <button
              type="submit"
              disabled={!manualToken.trim()}
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white text-xs font-semibold rounded-lg shrink-0 transition-colors"
            >
